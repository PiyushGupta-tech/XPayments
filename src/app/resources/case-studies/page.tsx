...
const studies = [
  { company: "Swiggy", quote: "Our teams have always worked together to achieve a better payment experience. XPayments conversion rates are a benchmark for the industry.", author: "Director Finance, Swiggy", metric: "20% lift in payment success" },
  { company: "Bigbasket", quote: "XPayments has been more of a partner than just a vendor. The breadth of knowledge in the payments space has been impressive.", author: "Product, Bigbasket", metric: "Streamlined integrations" },
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
        ...
        <p className="mt-6 max-w-3xl text-xl text-gray-600">
          Learn how leading businesses use XPayments to drive payment success and grow revenue.
        </p>
