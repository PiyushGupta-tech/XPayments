...
export default function PersonalPage() {
  return (
    <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
      <h1 className="text-4xl font-bold text-gray-900">1x Rupee for You</h1>
      <p className="mt-6 max-w-3xl text-lg text-gray-600">
        Shop, send, and manage your money with ease. Your way to pay, with 1x Rupee.
      </p>
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <Link href="/personal/shop" className="rounded-xl border border-gray-200 p-6 hover:border-primary">
          <h3 className="font-semibold text-gray-900">Shop with 1x Rupee</h3>
        ...
        <Link href="/personal/how-it-works" className="rounded-xl border border-gray-200 p-6 hover:border-primary">
          <h3 className="font-semibold text-gray-900">How 1x Rupee Works</h3>
